    ...
    return (
        <Card>
            <VStack gap="16">
                ...
                <HStack gap="8">
                    <Button data-testid="decrement-button" onClick={handleDec}>-1</Button>
                    <Button data-testid="increment-button" onClick={handleInc}>+1</Button>
                </HStack>
                <HStack gap="8">
                    <Input onChange={handleInput} value={value} type="number" />
                    <Button data-testid="plus-button" onClick={handleAdd}>+</Button>
                    <Button data-testid="minus-button" onClick={handleSubtract}>-</Button>
                </HStack>
            </VStack>
        </Card>
    );
